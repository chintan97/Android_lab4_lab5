...
public class StudentReaderDbHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_STUDENT_TABLE =
            "CREATE TABLE IF NOT EXISTS " + StudentEntry.TABLE_NAME + " (" +
                    ...
                    StudentEntry.COLUMN_STUDENT_ID + TEXT_TYPE + COMMA_SEP +
                    StudentEntry.COLUMN_STUDENT_NAME + TEXT_TYPE + COMMA_SEP +
                    StudentEntry.COLUMN_STUDENT_AGE + INTEGER_TYPE + " )";
    ...
    private static final String SQL_CREATE_COURSE_TABLE =
            "CREATE TABLE IF NOT EXISTS " + CourseEntry.TABLE_NAME + " (" +
                    ...
                    CourseEntry.COLUMN_COURSE_CODE + TEXT_TYPE + " )";
